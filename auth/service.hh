...
public:
    ...
    /// roles, role grants, permission grants, and attached service levels.
    ///
    future<std::vector<cql3::description>> describe_auth(bool with_salted_hashes) const;
...
private:
    ...
    future<std::vector<cql3::description>> describe_roles(bool with_salted_hashes) const;
