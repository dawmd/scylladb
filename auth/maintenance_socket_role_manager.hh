...
public:
    ...
    virtual future<role_to_directly_granted_map> query_all_directly_granted() const override;
    ...
    virtual future<std::vector<attached_service_level>> get_attached_service_levels() const override;
};
