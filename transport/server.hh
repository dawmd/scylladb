...
public:
    ...
    qos::effective_service_level_cache_subscriber* get_effective_service_level_cache_listener() const noexcept;
...
class cql_server::event_notifier : public service::migration_listener,
                                   ...
                                   public qos::effective_service_level_cache_subscriber
{
    cql_server& _server;
...
inline qos::effective_service_level_cache_subscriber* cql_server::get_effective_service_level_cache_listener() const noexcept { return _notifier.get(); }
}
