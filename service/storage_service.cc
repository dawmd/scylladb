...
future<> storage_service::handle_state_normal(inet_address endpoint, gms::permit_id pid) {
    ...
    if (existing && *existing != endpoint) {
        ...
        // This branch is taken when a node is replaced with the same or a different IP.
        ...
        // We do it after update_normal_tokens, allowing for tokens to be properly
        ...
        // This branch is taken if a fresh new node was added.
