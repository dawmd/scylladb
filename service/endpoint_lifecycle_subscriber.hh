...
public:
     ...
     */
    virtual void on_leave_cluster(const gms::inet_address& endpoint, const std::optional<locator::host_id>& maybe_hid) = 0;
...
public:
    ...
    future<> notify_left(gms::inet_address endpoint, std::optional<locator::host_id> maybe_hid);
