...
private:
    future<> excise(std::unordered_set<token> tokens, inet_address endpoint, locator::host_id, gms::permit_id);
    future<> excise(std::unordered_set<token> tokens, inet_address endpoint, locator::host_id, long expire_time, gms::permit_id);
...
private:
    ...
    future<> notify_left(inet_address endpoint, std::optional<locator::host_id> maybe_hid);
