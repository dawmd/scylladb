...
db::config::config(std::shared_ptr<db::extensions> exts)
    ...
    */
    ...
    , rf_rack_restricted_keyspaces(this, "rf_rack_restricted_keyspaces", liveness::LiveUpdate, value_status::Used, false, "Enforce RF=#rack or RF=1 for every keyspace using NetworkTopologyStrategy and tablets. This option should ONLY be used by developers.")
