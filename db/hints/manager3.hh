...
using node_to_hint_store_factory_type2 = utils::loading_shared_values<gms::inet_address, db::commitlog>;
using hints_store_ptr2 = node_to_hint_store_factory_type2::entry_ptr;
using hint_entry_reader2 = commitlog_entry_reader;
...
public:
    ...
    private:
        ...
        seastar::shared_mutex& _file_update_mutex;  // Why this if we have the pointer and vice versa?
                                                    // Do those point to different objects?
