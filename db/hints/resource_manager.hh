...
class resource_manager {
    ...
    service::storage_proxy* _proxy_ptr;
...
public:
    resource_manager(service::storage_proxy* proxy, size_t max_send_in_flight_memory, utils::updateable_value<uint32_t> max_hint_sending_concurrency)
