...
public:
    hint_sender(hint_endpoint_manager& parent, service::storage_proxy& local_storage_proxy, replica::database& local_db) noexcept;//, gms::gossiper& local_gossiper) noexcept;
    ~hint_sender();
