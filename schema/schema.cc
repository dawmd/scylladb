...
bytes_ostream& schema::schema_properties(const schema_describe_helper& helper, bytes_ostream& os) const {
    os << "bloom_filter_fp_chance = " << std::format("{}", bloom_filter_fp_chance());
    os << "\n    AND caching = {";
    ...
    os << "\n    AND crc_check_chance = " << std::format("{}", crc_check_chance());
    os << "\n    AND default_time_to_live = " << std::format("{}", default_time_to_live().count());
    os << "\n    AND gc_grace_seconds = " << std::format("{}", gc_grace_seconds().count());
    os << "\n    AND max_index_interval = " << std::format("{}", max_index_interval());
    os << "\n    AND memtable_flush_period_in_ms = " << std::format("{}", memtable_flush_period());
    os << "\n    AND min_index_interval = " << std::format("{}", min_index_interval());
